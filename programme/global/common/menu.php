<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a href="../../4-cas pratique/2-Catalogue/index.php" class="nav-link"><span>Catalogue</span></a>
            </li>
            <li class="nav-item">
                <a href="../../4-cas pratique/3-Animaux/index.php" class="nav-link"><span>Animaux</span></a>
            </li>
        </ul>
    </div>
</nav>