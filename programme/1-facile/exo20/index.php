...
<form action="" method="POST">
    <div class="form-group">
        <label>Note 1: </label>
        <input type="number" name="note1" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Note 2: </label>
        <input type="number" name="note2" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Note 3: </label>
        <input type="number" name="note3" class="form-control" required>
    </div>
...
if (
    ...
    echo "<h2>La moyenne des " . count($notes) . " notes est de : " . $moyenne . "</h2> <br>";
}
