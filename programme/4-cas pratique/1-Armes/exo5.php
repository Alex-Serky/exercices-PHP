...
$titre = "Exo 5 : Partie 5 - Amélioration de la classe : La POO "; //Mettre le nom du titre de la page que vous voulez
?>
...
<?php
    ...
    $arme1 = new Arme("épée", "epee/epee1.png", "Une arme bien tranchante");
    $arme2 = new Arme("arc", "arc/arc1.png", "Une arme à distance");
    $arme3 = new Arme("hâche", "hache/hache1.png", "Une arme tranchante ou un outil qui permet aussi de couper du bois");
    $arme4 = new Arme("fléau", "fleau/fleau4.png", "Une arme contondante du moyen âge");
